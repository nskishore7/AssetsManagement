...
let sidebarLinks = [
    { role: "employee", links: [{ label: "Dashboard", path: "/" }, { label: "My Assets", path: "/myassets" }, { label: "Request", path: "/requests" }] },
    { role: "admin", links: [{ label: "Dashboard", path: "/" }, { label: "Assets", path: "/assets" }, { label: "Employees", path: "/employees" }, { label: "Assigned Assets", path: "/assigned-assets" }, { label: "Request", path: "/requests" }] },
    { role: "super admin", links: [{ label: "Dashboard", path: "/" }, { label: "Admins", path: "/admins" }, { label: "Assets", path: "/assets" }, { label: "Employees", path: "/employees" }, { label: "Assigned Assets", path: "/assigned-assets" }, { label: "Request", path: "/requests" }] }
]
