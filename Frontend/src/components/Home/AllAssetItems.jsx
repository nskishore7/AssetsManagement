...
import AssetItemEditModal from '../AssetItemEditmodal'
      ...
      <>
        ...
        <div className="bg-white shadow-lg rounded-xl p-6 border mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-700">
            ...
            <p>
              <span className="font-semibold">Depreciation Method:</span> {data.depreciationMethod}
            </p>
            ...
            data.items.map((item) => (
              ...
              >
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={`text-xs px-3 py-1 rounded-full font-medium ${item.status === "available"
